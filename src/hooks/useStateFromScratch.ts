...
/**
 * Implementação do useState do zero usando useReducer
 * Baseado no artigo da DEV Community sobre Creating a useState hook from scratch
 */
...
/**
 * Versão ainda mais básica usando apenas closures (conceitual)
 * Esta seria uma implementação sem depender de outros hooks do React
 */
