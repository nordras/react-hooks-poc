...
export default function Dashboard() {
  ...
  const totalApplications = mockApplicationMetrics.reduce((sum, metric) => sum + metric.applications, 0);
  const totalDeployments = mockApplicationMetrics.reduce((sum, metric) => sum + metric.deployments, 0);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Visão geral dos times e métricas de aplicações
        </p>
      </div>
      ...
      <ApplicationsChart data={mockApplicationMetrics} />

      {/* Lista de times */}
      <div className="space-y-4">
        <h2 className="text-2xl font-bold">Times & Membros</h2>
